<x-filament-panels::page>
                        ...
                        @foreach($this->filteredProjects as $project)
                            ...
                            >
                                ...
                                @if($project->description)
                                    <div class="text-xs text-gray-500 dark:text-gray-400 line-clamp-2 mb-3 prose prose-sm max-w-none dark:prose-invert">
                                        {!! $project->description !!}
                                    </div>
                                @endif
    ...
    @else
            ...
            <x-filament::section>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <button
                            wire:click="$set('selectedProjectId', null)"
                        ...
                        <div>
                            ...
                            @if($selectedProject->description)
                                <div class="text-sm text-gray-500 dark:text-gray-400 prose prose-sm max-w-none dark:prose-invert">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <div class="w-10 h-10 bg-blue-200 dark:bg-blue-700 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div class="flex items-start justify-between gap-3">
                    <div class="flex-1 min-w-0">
                    ...
                    <div class="w-10 h-10 bg-green-200 dark:bg-green-700 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            {{-- Deviation Card --}}
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div class="flex items-start justify-between gap-3">
                    <div class="flex-1 min-w-0">
                        <p class="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Deviation</p>
                        <p class="text-2xl font-bold {{ $deviation >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                    ...
                    <div class="w-10 h-10 bg-purple-200 dark:bg-purple-700 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            {{-- Project Status Card --}}
            <div class="bg-gradient-to-br rounded-lg p-4 border border-gray-200 dark:border-gray-700
